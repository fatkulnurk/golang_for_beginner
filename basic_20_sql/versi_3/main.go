...
func sqlPrepare() {
	...
	// menggunakan prepare
	// kalau statementnya ebih dari satu bisa pakai ini dan keduanya harus di isi
	// stmt, err := db.Prepare("select name, grade from tb_student where id = ? and age=?")
	// kalau statement cuma 1 pakai ini
